...
from emotion_lexicon_score_mapping import *
...
def PreProcessing(tweet):
	...
	word_n_grams = WordNGrams(processed_tweet, 3)
	...
	return happy, sad, anger, fear, surprise, disgust, hashtags, usernames, \
		   ...
		   word_n_grams, upper_case_words, intensifiers, negations, score_vector

	#return repetitive_words

#tweet = "Heyyyyy I am verrryyy happppyyyy"
